...
from {{ cookiecutter.project_slug }}.modules.box__default.auth.email import _send_email_helper
from {{ cookiecutter.project_slug }}.modules.box__default.auth.email import send_async_email
