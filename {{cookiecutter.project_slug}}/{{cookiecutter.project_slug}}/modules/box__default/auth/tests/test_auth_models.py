...
from {{ cookiecutter.project_slug }}.modules.box__default.auth.models import AnonymousUser
from {{ cookiecutter.project_slug }}.modules.box__default.auth.models import Role
from {{ cookiecutter.project_slug }}.modules.box__default.auth.models import role_user_bridge
from {{ cookiecutter.project_slug }}.modules.box__default.auth.models import User
from {{ cookiecutter.project_slug }}.modules.box__default.auth.tests.factories import RoleFactory
from {{ cookiecutter.project_slug }}.modules.box__default.auth.tests.factories import UserFactory
